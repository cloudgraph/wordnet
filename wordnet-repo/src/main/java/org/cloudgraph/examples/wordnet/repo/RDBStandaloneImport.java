 ...
 * it is necessary to run 4 sequential import jobs, so we export the data into 4 files as below. 
 *   
 * java -jar ./wordnet-repo-0.5.2/wordnet-repo-0.5.2.jar -file wordnet-ref.xml    
 * java -jar ./wordnet-repo-0.5.2/wordnet-repo-0.5.2.jar -file wordnet-synsets.xml   
 * java -jar ./wordnet-repo-0.5.2/wordnet-repo-0.5.2.jar -file wordnet-words.xml   
 * java -jar ./wordnet-repo-0.5.2/wordnet-repo-0.5.2.jar -file wordnet-links.xml     
 */
public class RDBStandaloneImport extends ImportSupport {
	...
	private static void printUsage() {
		...
		System.out
				.println("--------------------------------------------------------------------------");
		System.out
				.println("java -jar wordnet-repo-0.5.2.jar [-size record-chunk-size] [-file import-file-name] ");
		System.out
				.println("--------------------------------------------------------------------------");
		System.out.println("examples:");
		System.out
				.println("java wordnet-repo-0.5.2.jar -size 10000 -file name");
		System.out
				.println("--------------------------------------------------------------------------");
	}
